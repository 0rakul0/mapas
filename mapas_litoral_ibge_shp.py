...
if __name__ == "__main__":
    m = mapa()
    shapefile_path = "./IBGE/Municipios_Defrontantes_com_o_Mar_2022.shp"
    gdf = gpd.read_file(shapefile_path, encoding='utf-8')
    print(gdf.info())
    print('tamanho', gdf.shape)

    gdf.plot()
    plt.title("Mapa do litoral do Brasil")
    plt.axis('off')  # Remova os eixos
    plt.show()
    plt.savefig('fig_mapa/mapa_litoral.png')
    ...
    #
    # df_vizinhanca.to_csv('data_master/vizinhos_municipios_litoral.csv', index=False, quoting=1)